...
accessButton.addEventListener("click",
    async function() {
        ...
        //check db
        //api call  , check if already registered
        let requestObj = {
            'method': 'POST',
            'headers': {
          ...
          //check db
        let fetchPromise = fetch("http://localhost:8080/auth/user/register", requestObj)
       ...
       console.log(responseData);
        ...
        // if(valid) window.location.href = "adminhomepage.html";
